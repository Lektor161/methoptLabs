...
public class Main {
    ...
    private static final List<QuadraticForm> forms = new ArrayList<>(List.of(
            ...
            new QuadraticForm(
                    new DiagMatrix(new DoubleVector(0.5d, 32d)),
    ...
    public static DoubleVector measureMethod(GradientOptimizationMethod method) {
    ...
    private static void outputMethodInfo(GradientOptimizationMethod method) {
