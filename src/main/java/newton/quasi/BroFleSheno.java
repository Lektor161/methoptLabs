...
public class BroFleSheno extends AbstractQuasiNewtonMethod {

    public BroFleSheno(final FunctionExpression function) {
        super(function);
    }

    public BroFleSheno(final Expression function, final int n) {
        super(function, n);
    }

    public BroFleSheno(final FunctionExpression function, final double eps) {
        super(function, eps);
    }
